...
namespace Sense.Vision.SaliencyModule
{
    ...
    {
        public TaskFactory SingleFactory { get; private set; }

        public LimitedConcurrencyLevelTaskScheduler()
        {
            SingleFactory = new TaskFactory(new LimitedConcurrencyLevelTaskScheduler(5));
        }
        ...
        public int getNumQueueTask()
        {
            return _tasks.Count();
        }

        public int getNumTaskRunning()
        {
